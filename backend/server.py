...
COUNTER_ENGINE = [
    ...
    },
    {
        ...
        "pari": {
            ...
            "w": 'Allarga la manovra per aggirare il folto blocco dei DMC centrali'
        },
        "debole": {
            "mod": '4-5-1 V-Style',
            "alt": '3N-1-4-2',
    ...
    {
        "av": 'Eiffel Tower 3W-2DMC-3N-1-1',
        "cat": 'att',
        "forte": {
            "mod": '4-5-1 V-Style',
            "alt": '4-4-2 C',
    ...
    },
    {
        ...
        "pari": {
            ...
            "w": "L'Hexagon bilancia la copertura contro la mobilità del Butterfly"
        },
        "debole": {
            "mod": '4-2-2-2 H',
            "alt": '4-3N-2-1',
    ...
    # --- 36 voci generate da MATCHUP_MATRIX (completamento 117) ---
    {
        "av": "3N-5-1-1",
        "cat": "att",
        "forte": {
